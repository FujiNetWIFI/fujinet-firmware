...
#
# Usage: ./build-cart.sh [board]          default board: fujiarcadia
#
...
# fujinet-config/arcadia (copy its build/config.bin here, or run its
# `make rom.h`); else the fujicfg testrom stand-in; else fujitest.
...
echo "build-cart.sh: firmware/build-$BOARD/fujiarcadia.uf2"
