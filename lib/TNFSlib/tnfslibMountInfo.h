...
#define TNFS_TIMEOUT 2000 // put back to 2000. We don't want to be too aggressive with retries, or we can cause more problems than we solve on a bad connection.
