...
public:
     ...
     * @return FUJI_ERROR::NONE on success, FUJI_ERROR::UNSPECIFIED on error
     */
    virtual fujiError_t rename(PeoplesUrlParser *url);
     ...
     * @return FUJI_ERROR::NONE on success, FUJI_ERROR::UNSPECIFIED on error
     */
    virtual fujiError_t del(PeoplesUrlParser *url) { return FUJI_ERROR::NONE; }
     ...
     * @return FUJI_ERROR::NONE on success, FUJI_ERROR::UNSPECIFIED on error
     */
    virtual fujiError_t mkdir(PeoplesUrlParser *url) { return FUJI_ERROR::NONE; }
     ...
     * @return FUJI_ERROR::NONE on success, FUJI_ERROR::UNSPECIFIED on error
     */
    virtual fujiError_t rmdir(PeoplesUrlParser *url) { return FUJI_ERROR::NONE; }
     ...
     * @return FUJI_ERROR::NONE on success, FUJI_ERROR::UNSPECIFIED on error
     */
    virtual fujiError_t lock(PeoplesUrlParser *url) { return FUJI_ERROR::NONE; }
     ...
     * @return FUJI_ERROR::NONE on success, FUJI_ERROR::UNSPECIFIED on error
     */
    virtual fujiError_t unlock(PeoplesUrlParser *url) { return FUJI_ERROR::NONE; }
...
protected:
     ...
     * @return FUJI_ERROR::NONE on success, FUJI_ERROR::UNSPECIFIED on error
     */
    virtual fujiError_t open_file();

    /**
     * @brief open a file handle to fd
     * @return FUJI_ERROR::NONE on success, FUJI_ERROR::UNSPECIFIED on error
     */
    virtual fujiError_t open_file_handle() = 0;
     ...
     * @return FUJI_ERROR::NONE on success, FUJI_ERROR::UNSPECIFIED on error
     */
    virtual fujiError_t open_dir_handle() = 0;
     ...
     * @return FUJI_ERROR::NONE on success, FUJI_ERROR::UNSPECIFIED on error
     */
    virtual fujiError_t mount(PeoplesUrlParser *url) = 0;

    /**
     * @brief Unmount TNFS server specified in mountInfo.
     * @return FUJI_ERROR::NONE on success, FUJI_ERROR::UNSPECIFIED on error
     */
    virtual fujiError_t umount() = 0;
     ...
     * @return FUJI_ERROR::NONE on success, FUJI_ERROR::UNSPECIFIED on error
     */
    virtual fujiError_t read_file(unsigned short len);
     ...
     * @return FUJI_ERROR::NONE on success, FUJI_ERROR::UNSPECIFIED on error
     */
    virtual fujiError_t read_dir(unsigned short len);
     ...
     */
    virtual fujiError_t read_dir_entry(char *buf, unsigned short len) = 0;
     ...
     * @return FUJI_ERROR::NONE on success, FUJI_ERROR::UNSPECIFIED on error
     */
    virtual fujiError_t status_file(NetworkStatus *status);
     ...
     * @return FUJI_ERROR::NONE on success, FUJI_ERROR::UNSPECIFIED on error
     */
    virtual fujiError_t close_file();

    /**
     * @brief close file handle
     * @return FUJI_ERROR::NONE on success, FUJI_ERROR::UNSPECIFIED on error
     */
    virtual fujiError_t close_file_handle() = 0;

    /**
     * @brief close directory.
     * @return FUJI_ERROR::NONE on success, FUJI_ERROR::UNSPECIFIED on error
     */
    virtual fujiError_t close_dir();

    /**
     * @brief Close directory handle
     * @return FUJI_ERROR::NONE on success, FUJI_ERROR::UNSPECIFIED on error
     */
    virtual fujiError_t close_dir_handle() = 0;
     ...
     * @return FUJI_ERROR::NONE on success, FUJI_ERROR::UNSPECIFIED on error
     */
    virtual fujiError_t write_file(unsigned short len);
     ...
     * @return FUJI_ERROR::NONE on success, FUJI_ERROR::UNSPECIFIED on error
     */
    virtual fujiError_t write_file_handle(uint8_t *buf, unsigned short len) = 0;

    /**
     * @brief get status of file, filling in filesize. mount() must have already been called.
     */
    virtual fujiError_t stat() = 0;
