...
public:
     ...
     */
    fujiError_t accept_connection();

    /**
     * Close client connection.
     */
    fujiError_t close_client_connection();
...
protected:
     ...
     * @return FUJI_ERROR::NONE on success, FUJI_ERROR::UNSPECIFIED on error
     */
    fujiError_t open_server(unsigned short port);
     ...
     * @return FUJI_ERROR::NONE on success, FUJI_ERROR::UNSPECIFIED on error
     */
    fujiError_t open_client(std::string hostname, unsigned short port);
