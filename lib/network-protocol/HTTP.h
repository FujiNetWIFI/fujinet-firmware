...
private:
     ...
     * @return FUJI_ERROR::NONE on success, FUJI_ERROR::UNSPECIFIED on error
     */
    fujiError_t read_file_handle_header(uint8_t *buf, unsigned short len);
     ...
     * @return FUJI_ERROR::NONE on success, FUJI_ERROR::UNSPECIFIED on error
     */
    fujiError_t read_file_handle_data(uint8_t *buf, unsigned short len);
     ...
     * @return FUJI_ERROR::NONE on success, FUJI_ERROR::UNSPECIFIED on error
     */
    fujiError_t write_file_handle_get_header(uint8_t *buf, unsigned short len);
     ...
     * @return FUJI_ERROR::NONE on success, FUJI_ERROR::UNSPECIFIED on error
     */
    fujiError_t write_file_handle_set_header(uint8_t *buf, unsigned short len);
     ...
     * @return FUJI_ERROR::NONE on success, FUJI_ERROR::UNSPECIFIED on error
     */
    fujiError_t write_file_handle_send_post_data(uint8_t *buf, unsigned short len);
     ...
     * @return FUJI_ERROR::NONE on success, FUJI_ERROR::UNSPECIFIED on error
     */
    fujiError_t write_file_handle_data(uint8_t *buf, unsigned short len);
     ...
     * @return FUJI_ERROR::NONE on success, FUJI_ERROR::UNSPECIFIED on error
     */
    fujiError_t parseDir(char *buf, unsigned short len);
