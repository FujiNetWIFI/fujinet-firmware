...
public:
     ...
     * @return NETPROTO_ERR_NONE on success, NETPROTO_ERR_UNSPECIFIED on error
     */
    netProtoErr_t special_40(uint8_t *sp_buf, unsigned short len,
     ...
     */
    netProtoErr_t special_80(uint8_t *sp_buf, unsigned short len,
                             cmdFrame_t *cmdFrame) override;
