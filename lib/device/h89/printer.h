#ifndef H89_PRINTER_H
#define H89_PRINTER_H
...
class H89Printer : public virtualDevice
{
protected:
    // SIO THINGS
...
public:
    ...
    H89Printer(FileSystem *filesystem, printer_type printer_type = PRINTER_FILE_TRIM);
    ~H89Printer();
