#ifndef S100SPI_PRINTER_H
#define S100SPI_PRINTER_H
...
class s100spiPrinter : public virtualDevice
{
protected:
    // SIO THINGS
...
public:
    ...
    s100spiPrinter(FileSystem *filesystem, printer_type printer_type = PRINTER_FILE_TRIM);
    ~s100spiPrinter();
