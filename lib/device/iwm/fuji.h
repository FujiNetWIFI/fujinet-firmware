...
protected:
    ...
    void iwm_net_get_wifi_status();         // status 0xFA
    void iwm_mount_host();                  // 0xF9
    void iwm_disk_image_mount();            // 0xF8
    /*
   ...
   */
    void iwm_disk_image_umount();      // 0xE9
  /*
    ...
    */
    ...
    void iwm_set_boot_config();            // 0xD9
    void iwm_copy_file();                  // 0xD8
    void iwm_set_boot_mode();              // 0xD6
