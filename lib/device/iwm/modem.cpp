...
iwm_device_info_block_t iwmModem::create_dib_reply_packet()
{
  iwm_device_info_block_t dib;

  dib.stat_code = STATCODE_READ_ALLOWED | STATCODE_WRITE_ALLOWED | STATCODE_DEVICE_ONLINE;
  dib.block_size = 0;
  strcpy(dib.name, "MODEM");
