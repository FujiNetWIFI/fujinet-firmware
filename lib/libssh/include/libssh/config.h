...
// COMPAT additions for esp-idf-libssh

// this blocks out some of the libssh directory checking
#define LIBSSH_FUJINET 1
...
// Can this possibly work? Only used for server setup
