...
// Name clash with xtensa/config/specreg.h:48
#define CHANNELS_WINDOWBASE 1280000
#define WINDOWLIMIT (CHANNELS_WINDOWBASE/2)
...
{
  uint32_t new_window = minimumsize > CHANNELS_WINDOWBASE ? minimumsize : CHANNELS_WINDOWBASE;
  int rc;
