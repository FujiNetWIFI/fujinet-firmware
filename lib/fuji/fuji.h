...
#include "../device/sio/network.h"
#include "../device/sio/cassette.h"
#include "../device/sio/modem.h"
#include "../device/sio/apetime.h"
#include "../device/sio/voice.h"
#include "../device/sio/printerlist.h"
#include "../device/sio/midimaze.h"
#include "../device/sio/siocpm.h"
