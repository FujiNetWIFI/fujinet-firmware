...
TRIP           ORG *+1       ; INTR FLAG
AX1SV          ORG *+MAXDEV  ; AUX1 SAVE
AX2SV          ORG *+MAXDEV  ; AUX2 SAVE
STSV           ORG *+4*MAXDEV ; STATUS SAVE
RLEN           ORG *+MAXDEV  ; RCV LEN
ROFF           ORG *+MAXDEV  ; RCV OFFSET
TOFF           ORG *+MAXDEV  ; TRX OFFSET
INQDS          ORG *+1       ; DSTATS INQ

       ; BUFFERS (PAGE ALIGNED)

       ORG     * + $FF & $FF00

RBUF           ORG *+256*MAXDEV      ; RX
TBUF           ORG *+256*MAXDEV      ; TX
