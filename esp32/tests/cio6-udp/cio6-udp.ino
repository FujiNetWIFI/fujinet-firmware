/**
   Test #26 - CIO 6 - TCP and UDP
*/

#define TEST_NAME "#FujiNet CIO #6 - TCP and UDP"
...
#ifdef DEBUG
  Debug_printf("Listening for UDP on port %d\n", udpPort);
#endif
...
void sio_read()
{
  ...
  else
  {
    ...
    offset -= 128;
    offset += 16;
    cio6.seek(offset, SeekSet);
    cio6.read(sector, 128);
  }
