#ifdef PINMAP_FUJIVERSAL_COLECO

// Emerson Arcadia 2001. The console side is an RP2040 cartridge (see
// pico/coleco/) that serves the 8K cart window and a read-hotspot mailbox;
// this ESP32-S3 is the USB *host* on the other end of that link, exactly as
// for fujiversal-o2/astrocade. Nothing here is Arcadia-specific -- the
// console identity lives entirely in the RP2040 firmware. See
// pico/coleco/README.md.
//
...
// over from fujiversal-arcadia.h so the SD/UART/LED paths need no change. The
...
// default and what the fujicoleco cart enumerates as; the PID varies with
...
#endif /* PINMAP_FUJIVERSAL_COLECO */
