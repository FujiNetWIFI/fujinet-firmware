#ifdef PINMAP_FUJIVERSAL_CHANNELF

// Fairchild Channel F. The console side is an RP2040 Videocart (see
// pico/channelf/) that serves a 16K ROM window and a 32K arena carrying the
// mailbox; this ESP32-S3 is the USB *host* on the other end of that link,
// exactly as for fujiversal-o2/astrocade/arcadia. Nothing here is Channel
// F-specific -- the console identity lives entirely in the RP2040 firmware.
// See pico/channelf/README.md.
//
...
#endif /* PINMAP_FUJIVERSAL_CHANNELF */
