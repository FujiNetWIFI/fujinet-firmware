#ifdef PINMAP_FUJIVERSAL_ARCADIA

// Emerson Arcadia 2001. The console side is an RP2040 cartridge (see
// pico/arcadia/) that serves the 8K cart window and a read-hotspot mailbox;
...
// carried over from fujiversal-astrocade.h so the SD/UART/LED paths need no
...
#endif /* PINMAP_FUJIVERSAL_ARCADIA */
