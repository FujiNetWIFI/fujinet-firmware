...
private:
    ...
    char * mac_to_string(char dest[18], uint8_t mac[6]);
...
public:
    ...
    int get_scan_result(uint8_t index, char ssid[32], uint8_t *rssi=NULL, uint8_t *channel=NULL, char bssid[18]=NULL, uint8_t *encryption=NULL);
