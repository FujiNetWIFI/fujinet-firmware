...
/* Define to 1 if the number of available CPU cores can be detected with
   pstat_getdynamic(). */
#define TUKLIB_CPUCORES_PSTAT_GETDYNAMIC 1
...
/* Define to 1 if the amount of physical memory can be detected with
   getinvent_r(). */
#define TUKLIB_PHYSMEM_GETINVENT_R 1

/* Define to 1 if the amount of physical memory can be detected with
   getsysinfo(). */
#define TUKLIB_PHYSMEM_GETSYSINFO 1

/* Define to 1 if the amount of physical memory can be detected with
   pstat_getstatic(). */
#define TUKLIB_PHYSMEM_PSTAT_GETSTATIC 1
...
/* Define to 1 to use unsafe type punning, e.g. char *x = ...; *(int *)x =
   123; which violates strict aliasing rules and thus is defineined behavior 1
