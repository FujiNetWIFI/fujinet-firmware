...
#ifdef ESP_PLATFORM
/* ESP32: Forward declare struct addrinfo - it's defined in lwip/netdb.h which will be included later */
struct addrinfo;
#endif
...
#if !defined(HAVE_SOCKADDR_STORAGE) && !defined(WIN32) && !defined(PS2_EE) && !defined(ESP_PLATFORM)
/*
